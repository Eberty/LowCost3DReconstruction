...
4. [integration.sh](https://github.com/Eberty/LowCost3DReconstruction/blob/master/scripts/integration.sh)
    ...
    * For comparison purposes, three meshes will be generated: the one produced with the aligned depth sensor data, the one generated by the SFM + MVS pipeline and the hybrid model containing the merging of data from these different capture methods. The hybrid model is the expected result of our pipeline.
...
2. Select **File** > **Import mesh** > "Choose the **hybrid_mesh_texture.ply** file"
